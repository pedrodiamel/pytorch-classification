...
def pad(image, h_pad, w_pad, padding_mode=cv2.BORDER_CONSTANT):
...
class Generator(object):
    ...
    def generate(self, image, back, pad=10):
        ...
        image_org, image_ilu, mask = self.mixture(
            image, mask, back, self.iluminate, self.angle, self.translation, self.warp, self.factor
        )
