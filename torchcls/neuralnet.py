...
from . import losses as nloss, utils as ult
...
class NeuralNetClassifier(NeuralNetAbstract):
    ...
    def __init__(self, patchproject, nameproject, no_cuda=True, parallel=False, seed=1, print_freq=10, gpu=0):
    ...
    def representation(self, data_loader):
        ...
        for i, sample in enumerate(data_loader):
            ...
            print(
                "Representation: |{:06d}/{:06d}||{batch_time.val:.3f} ({batch_time.avg:.3f})|".format(
