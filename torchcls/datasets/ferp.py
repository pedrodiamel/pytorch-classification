...
folder_names = {"Training": "FER2013Train", "PublicTest": "FER2013Valid", "PrivateTest": "FER2013Test"}
                    ...
                    if emotion_raw[i] == maxval:
                        ...
                        if i >= 8:  # unknown or non-face share same number of max votes
                            ...
                            if sum(emotion) > maxval:  # there have been other emotions ahead of unknown or non-face
                                ...
                                count -= 1
                            break
            if sum(emotion) <= 0.5 * sum_list or count > 3:  # less than 50% of the votes are integrated,
